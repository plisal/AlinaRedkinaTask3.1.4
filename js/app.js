...
let buttonManagementText = document.querySelector('.services__button-management-text');
...
const handleButtonManagementClick = () => {
  if (buttonManagement.classList.contains('services__button-management--hidden')) {
